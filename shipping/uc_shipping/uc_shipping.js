function apply_address(type, json_address){
  if (json_address != "0"){
    ...
    $('input[@name=' + type + '_first-name]').val(address.first_name);
    $('input[@name=' + type + '_last-name]').val(address.last_name);
    ...
    $('input[@name=' + type + '_postal-code]').val(address.postal_code);
